...
public class RectangleRunner {
    public static void main(String[] args){
        ...
        int totalArea = plot1.calculateArea();
        totalArea += plot2.calculateArea();
        totalArea += plot3.calculateArea();
        System.out.println("These three plots require " + totalArea + " square foot of seed.");
